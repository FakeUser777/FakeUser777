...
function Script()
    local Window = Library.CreateLib("PNN master", "GrapeTheme")
    ...
    MainSection:NewButton("Rage", "Inclui esp e aim tiro.", function()
...
while wait(5) do
    ...
    MainSection:NewButton("Brutal", "Inclui esp e silent-wall 100%.", function()
        if (not game:IsLoaded()) then
    game.Loaded:Wait();
end
